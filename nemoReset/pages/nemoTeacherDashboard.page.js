...
module.exports = {
    elements: {
        ...
        myLibrary:{
            selector:"[qid=tDashboard-24]"
        },
         courseMaterialSearchBox:{
            selector:"[qid=tDashboard-30]"
        },
        courseMaterial:{
            selector:"[class=product] a"
        }
    ...
    commands: [
        {
            ...
            openMyLibrary: function(){
                actions.click(this,this.elements.myLibrary.selector);
            },
            waitForPageLoad: function(){
                this.api.perform(function() {
                    testlog.info("Waiting for Dashboard Page to get loaded")
                })
                  actions.waitForElementVisible(this,'[class=welcome-msg]',50000);
              },
              waitForCourseMaterialSearchTextBoxToAppear: function(){
                this.api.perform(function() {
                    testlog.info("Waiting for Search Course Material Text Box to get loaded")
                })
                this.api.useCss();
                actions.waitForElementVisible(this,this.elements.courseMaterialSearchBox.selector,60000);
            },
            searchCourseMaterial: function(courseMaterialName){
                this.api.perform(function() {
                    testlog.info("Seaching for Dashboard Page to get loaded")
                })
                this.api.useCss();
                actions.setValue(this,this.elements.courseMaterialSearchBox.selector,courseMaterialName)
                actions.waitForElementVisible(this,'[qid=tDashboard-31-0]',60000);
                actions.click(this,'[qid=tDashboard-31-0]')
                
            },
            clickCourseMaterial: function(courseMaterialName){
                this.api.perform(function() {
                    testlog.info("clicking on searched course material")
                })
                this.api.useCss();
                actions.click(this,this.elements.courseMaterial.selector)
            }
        }
    ]
};
